...
Built in R using Seurat  |  Data: Liao et al. 2020, Nature Medicine  |  GEO: GSE149689
...
Severe vs Influenza	843 (most DEGs)	More genes up in Influenza (572 vs 271)	Most informative comparison

Severity is not a bigger immune response — it is a more dysregulated one, concentrated in specific innate pathways.

Key Biological Findings
Dramatic shift toward innate immune dominance — ISG Monocytes, Inflamed Monocytes, and Activated Monocytes are disproportionately expanded vs. healthy and mild cases.Monocyte expansion in severe COVID: 
Cluster 7 (SIGLEC1+, IFI44L+) exceeds influenza levels — pointing to a SARS-CoV-2-specific interferon dysregulation, not a generic viral response.ISG Monocyte signature is COVID-specific: 
Influenza has more upregulated genes than severe COVID — severity is driven by dysregulation in targeted innate pathways, not a globally stronger response.Dysregulation, not volume: 
Severe COVID shows relative depletion of the adaptive immune compartment in BALF, consistent with impaired adaptive responses.T cell suppression at infection site: 
Compositional shifts and DEG patterns together suggest a breakdown in innate-adaptive coordination in severe COVID-19.Innate-adaptive imbalance: 
...
Data Download
Download matrix.mtx, features.tsv, and barcodes.tsv from GSE149689 and place in one folder.
Run
...
Output Files
File	Description
01_QC_prefilter.png	QC metrics before filtering
02_QC_postfilter.png	QC metrics after filtering
03_HVG.png	Highly variable genes plot
04_Elbow.png	PCA elbow plot
05_feature_plots.png	Canonical markers on UMAP
06_dotplot.png	Dot plot of marker expression
07_UMAP_annotated.png	Main result — annotated UMAP
08_UMAP_condition.png	UMAP colored by condition
09_composition_bar.png	Cell type composition per condition
10_volcano_Severe_vs_Healthy.png	DEG volcano plot
11_volcano_Severe_vs_Mild.png	DEG volcano plot
12_volcano_Severe_vs_Influenza.png	DEG volcano plot
markers_all.csv	17,807 DE genes across all clusters
markers_top5.csv	Top 5 markers per cluster
cell_composition.csv	Cell type counts per condition
DEG_SevereCOVID_vs_Healthy.csv	Differential expression results
DEG_SevereCOVID_vs_MildCOVID.csv	Differential expression results
DEG_SevereCOVID_vs_Influenza.csv	Differential expression results
gse149689_final.rds	Annotated Seurat object (root dir)

Reference
Liao M, Liu Y, Yuan J, et al. Single-cell landscape of bronchoalveolar immune cells in patients with COVID-19. 
Nature Medicine. 2020;26:842–844. https://doi.org/10.1038/s41591-020-0901-9
